    ...
    <div className=''>
      ...
      <div className="flex justify-between p-4 text-[#00204a]">
        <div className="leading-relaxed pt-8 px-7" >
          ...
          <h1 className="text-5xl font-bold" >I'm Daisy,</h1> <br></br>
          <p className="text-3xl pb-3.5">A Software Developer and Cloud Professional <br></br>dedicated to helping businesses <br></br> stand out online and attract more customers</p>
